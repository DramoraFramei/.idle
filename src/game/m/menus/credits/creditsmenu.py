...
from src.game.m.menus.credits.cmui.buttons import buttons
from src.game.m.menus.credits.cmui.table import draw_table, get_credits_table
...
def creditsmenu() -> None:
    ...
    while running:
        events = pygame.event.get()  # Get the events from the pygame event queue
